...
import {mergeSortMarkdown} from "../../Markdown/Markdown";
...
class MergeSortDocumentation extends React.Component<Props, State> {
...
export default MergeSortDocumentation;