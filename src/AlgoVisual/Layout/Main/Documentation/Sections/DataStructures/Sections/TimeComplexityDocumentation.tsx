...
import {timeComplexityMarkdown} from "../../Markdown/Markdown";
...
class TimeComplexityDocumentation extends React.Component<Props, State> {
            ...
            <div className={"documentation-wrapper"}>
                <div className={"markdown-wrapper"}>
                    <div className={"markdown"}>
                        <ReactMarkdown
                            children={timeComplexityMarkdown}
...
export default TimeComplexityDocumentation;